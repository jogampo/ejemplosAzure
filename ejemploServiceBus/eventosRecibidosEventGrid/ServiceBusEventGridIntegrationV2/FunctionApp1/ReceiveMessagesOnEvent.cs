...
namespace SBEventGridIntegrationV2
{
    ...
    {
        const string ServiceBusConnectionString = "Endpoint=sb://contosoorderjose.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=JxJ6oMPsHoX2GR6UcYCrr3HyW2Ea+dCA++ASbKO+hWU=";
